...
'''
    ...
    try:
        while True:
            print(f"Battery voltage: {BP.get_voltage_battery():6.3f}  9v voltage: {BP.get_voltage_9v():6.3f}  5v voltage: {BP.get_voltage_5v():6.3f}  3.3v voltage: {BP.get_voltage_3v3():6.3f}")
